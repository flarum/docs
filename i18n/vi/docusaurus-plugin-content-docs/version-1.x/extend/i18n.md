...
Flarum có hệ thống dịch thuật mạnh mẽ (dựa trên [Translator của Symfony](https://symfony.com/doc/5.2/translation.html) và [ICU MessageFormat](https://symfony.com/doc/5.2/translation/message_format.html)) cho phép giao diện hiển thị thông tin bằng hầu hết mọi ngôn ngữ. Bạn nên cân nhắc việc tận dụng bản dịch của Flarum khi phát triển tiện ích mở rộng của mình, ngay cả khi bạn không có ý định sử dụng nó bằng nhiều ngôn ngữ duy nhất.
