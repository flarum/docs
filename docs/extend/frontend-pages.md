...
To allow this, Flarum creates (and stores) instances of [`PageState`](https://api.docs.flarum.org/js/2.x/classes/flarum.common_states_pagestate.pagestate) as `app.current` and `app.previous`.
These store:
