...
*Tutte queste azioni sono passibili di azione da parte dei moderatori. Se hai un problema con un altro membro, ti chiediamo di non affrontarlo da solo. Se è sul forum, utilizza il comando Segnala sul post in questione, quindi lascia che sia lo staff a occuparsi della situazione. Altrimenti, segnalare la violazione usando la [pagina contatti](https://flarum.org/foundation/contact), opzione Legale.
...
- Se non si usa un tag riservato per l'uso multilingue, *pubblicare solo in inglese*. Non possiamo aiutare se non capiamo i messaggi.
