...
Flarum features a powerful translation system (based on [Symfony's translator](https://symfony.com/doc/5.2/translation.html) and [ICU MessageFormat](https://symfony.com/doc/5.2/translation/message_format.html)) that allows the interface to display information in virtually any language. Bạn nên cân nhắc việc tận dụng bản dịch của Flarum khi phát triển tiện ích mở rộng của mình, ngay cả khi bạn không có ý định sử dụng nó bằng nhiều ngôn ngữ duy nhất.

Thứ nhất, hệ thống này sẽ cho phép bạn thay đổi thông tin được hiển thị bởi tiện ích mở rộng của bạn mà không cần chỉnh sửa mã thực. Nó cũng sẽ cung cấp cho bạn các công cụ cần thiết để đối phó hiệu quả với các hiện tượng như đa dạng hóa và thỏa thuận về giới. Và bạn không bao giờ biết: nó có thể hữu ích sau này nếu bạn quyết định muốn thêm nhiều ngôn ngữ hơn và cung cấp tiện ích mở rộng của mình cho người dùng trên khắp thế giới!
