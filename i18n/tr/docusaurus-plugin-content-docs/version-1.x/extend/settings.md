...
Because Flarum uses <a href="https://laravel.com/docs/8.x/container">Laravel's service container</a> (or IoC container) for dependency injection, you don't need to worry about where to obtain such a repository, or how to instantiate one.
