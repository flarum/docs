...
It's time to set up our little JavaScript transpilation project. It's time to set up our little JavaScript transpilation project. A typical extension will have the following frontend structure:
