...
¿Estás interesado en contribuir al desarrollo de Flarum? That's great! Desde [abrir un informe de error](bugs.md) hasta crear un pull request: toda contribución es apreciada y bienvenida. Flarum wouldn't be possible without our community contributions.
