...
Flarum features a powerful translation system (based on [Symfony's translator](https://symfony.com/doc/current/translation.html) and [ICU MessageFormat](https://symfony.com/doc/current/translation/message_format.html)) that allows the interface to display information in virtually any language. You should consider taking advantage of Flarum's translator as you develop your extension, even if you have no intention of using it in more than a single language.
...
See the [Symfony Translation docs](https://symfony.com/doc/current/translation/message_format.html) for more complex examples.
...
You can learn more about the Translator's methods in [Symfony's `Translator` documentation](https://symfony.com/doc/current/translation/message_format.html), which Flarum's `Translator` extends.
